...
export const Default = ({cambioTable}) => {
    ...
    const [initialValues, setInitialValues] = useState(({txtNombre:'', txtConcepto:'', stTipo:'', stCategoria:'', txtMonto:'',txtFechaTentativaPago:''}));

    const onChange: DatePickerProps['onChange'] = (date, dateString) => {
      setInitialValues(({txtNombre:fn.obtenerValor("#txtNombre"), txtConcepto:fn.obtenerValor("#txtConcepto"), stTipo:fn.obtenerValor("#stTipo"), stCategoria:fn.obtenerValor("#stCategoria"), txtMonto:fn.obtenerValor("#txtMonto"), txtFechaTentativaPago:dayjs(dateString)}));
    };
    ...
    const handleCancel = () => {
      setInitialValues(({txtNombre:"", txtConcepto:"", stTipo:'0', stCategoria:'0', txtMonto:'',txtFechaTentativaPago:''}));
